...
namespace Esri.ArcGISMapsSDK.Samples.Components
{
	...
	public class ArcGISTabletopInputControllerComponent : MonoBehaviour
	{
		...
		public void StartPointDrag(Vector2 screenPoint)
		{
			...
			if (tabletopControllerComponent.Raycast(dragStartRay, out var dragCurrentPoint))
			{
				isDragging = true;
		...
		public void StartTwoPointZoom(Vector3 position0, Vector3 position1)
		{
			...
			if (tabletopControllerComponent.Raycast(zoomStartRay0, out var zoomCurrentPoint0) && tabletopControllerComponent.Raycast(zoomStartRay1, out var zoomCurrentPoint1))
			{
				isZooming = true;
		...
		public void UpdatePointDrag(Vector3 screenPoint)
		{
			if (isDragging)
			{
				...
				tabletopControllerComponent.Raycast(updateRay, out var dragCurrentPoint);
		...
		public void UpdateTwoPointZoom(Vector3 position0, Vector3 position1)
		{
			if (isZooming)
			{
				...
				if (tabletopControllerComponent.Raycast(zoomRay0, out var zoomCurrentPoint0) && tabletopControllerComponent.Raycast(zoomRay1, out var zoomCurrentPoint1))
				{
		...
		public void ZoomMap(float zoom, Vector3 screenPoint)
		{
			...
			if (tabletopControllerComponent.Raycast(zoomRay, out _))
			{
				// More zoom means smaller extent
